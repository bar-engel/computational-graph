...
import graph.Config;
import graph.Graph;
import graph.MathExampleConfig;
...
public class MainTrain {
    ...
    public static void testCycles() {
        ...
        Node c = new Node("C");
        Node d = new Node("D");
        a.addEdge(b); b.addEdge(c); c.addEdge(d);
    ...
    public static class GetAgent implements Agent {
        ...
        public void reset() {}
        public void callback(String topic, Message msg) { this.msg = msg; }
        public void close() {}
    }
    ...
    public static void testTopicsGraph() {
        ...
        boolean b = true;
        for (Node n : g) b &= l.contains(n.getName());
        if (!b)
